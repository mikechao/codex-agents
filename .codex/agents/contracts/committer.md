...
- For linked follow-ups, the allowlist is the final combined review target, not the narrow remediation
  mutation scope. Stage every still-changed path in that combined receipt, while leaving unchanged
  inherited paths unstaged and excluding unrelated dirty paths.
